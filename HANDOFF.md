...
| 7c | **Elke missie begint met een val van 1,6 meter die 0,35 s duurt** — zolang is de besturing niet van jou. Nu gemeten en zichtbaar in elke bar-run. | **Nog niet aanraken.** De marge bestaat om te voorkomen dat je in de vloer spawnt, en of hij kleiner kan hangt af van de hoogte van de echte insertiepunten in de map. Dat verifiëren vraagt een run met beeld. Zeg of je die val merkt bij het starten — merk je hem niet, dan laten we hem. |
