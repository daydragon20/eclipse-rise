...
**Bekende volgende zwakste punten (15.8-lijst):** (1) Quaternius-characterpack (FBX, CC0) als squad/vijand-placeholder-body; (2) particles (vonken/as/embers, Kessara-smog); (3) district-verticaliteit (03.3 layer-cake); (4) zodra Fab-packs in het project staan: de echte kit-pass (graybox-gebouwen vervangen); (5) lit-toon herbeoordelen bij interieur/dag-scène.
