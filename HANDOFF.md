...
- **De getallen in dit document zijn tegen verse metingen gelegd** — vijf keer, laatst om 07:05, toen alle vijftien kopgetallen stuk voor stuk zijn teruggezocht in de 174 gemeten waarden. De eerste twee controles vonden een fout, de laatste drie niets. Wil je het zelf nakijken: `python Eclipse/Tools/show_measurements.py [woord]`.
...
| 9 | **Bereikasymmetrie.** Jouw wapen staat op 5000 cm maar raakt effectief tot **4700** (de kogel vertrekt vanaf de camera); de vijand ziet je pas op 2500–3000. Buiten hun bereik is het risicoloos; binnen hun bereik lig je in **2,50 s** neer. | **Speel eerst één gevecht.** Beide getallen zijn nu gemeten en het zijn er twee die dezelfde keuze beschrijven. Mijn voorkeur als je niets wilt uitproberen: waarneming omhoog naar ~4000, want dat raakt alleen de vijand en niet jouw wapengevoel. |
...
| 14b | **De +20-bonus voor een ronde zonder gewonden kan niet uitbetaald worden.** Hij hangt aan een optioneel objective dat *voltooid* moet zijn, en niets voltooit het — het is een voorwaarde, geen taak. Gemeten: nul gewonden, 25 materiaal in plaats van 45. **Je ziet hem ook staan:** de HUD toont *"Bring everyone home standing (optional)"* die nooit afvinkt. | **Doen.** Een voorwaarde-objective hoort zichzelf af te vinken bij de debrief als de voorwaarde geldt. Het raakt wel je economie (elke stille ronde levert dan 20 materiaal meer op), dus het is jouw keuze — maar een stretch-doel dat in de HUD staat en nooit uitbetaalt is erger dan geen stretch-doel. |
...
| 21 | **Drie van je vier missies beschrijven een vijandopstelling die nooit gebeurt.** `MT_Assault` (2 batches), `MT_Rescue` (2) en `MT_Sabotage` (1) vullen `EnemySpawns` in — welk archetype, hoeveel, op welk site. Niets leest dat veld: elke missie krijgt vier gemengde vijanden uit een vaste lus, naast het primaire doel. Gevonden om 07:20 door de omgekeerde vraag ("welke knop kan hij verdraaien zonder effect"), en het is de enige van die reeks die je missieontwerp raakt in plaats van alleen een tuninggetal. | **Sluit het aan** — de data is er al en beschrijft wat je bedoelde, dus het is grotendeels leeswerk in `SpawnMissionActors`. Maar het verandert de moeilijkheid van alle drie de missies in één klap (aantal, type én plaats van vijanden), en dat wil je gespeeld beoordelen, niet gemeten. Wil je dat niet nu: haal de data dan wég in plaats van hem te laten staan, want zolang hij er staat leest hij als waarheid. |
