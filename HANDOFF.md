...
**Bekende volgende zwakste punten (15.8-lijst voor de volgende pass):** (1) de voorgrond-vloer is een groot leeg vlak — straat-dressing (decals/markering/klein grut) of donkerder gradiënt; (2) glow-raamstroken zijn schaars zichtbaar vanaf de grond — dichtheid/plaatsing itereren; (3) de **lit-toon-migratie** (banden uit echt N·L + VSM-schaduw + software-Lumen-GI op lit district-materiaal) — dat is de echte 15.5-revisie-milestone; SSAO wordt dan pas zinvol (no-op op unlit emissive); (4) particles (vonken/as/embers) per de revisie.
