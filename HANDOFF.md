...
**Bekende volgende zwakste punten (15.8-lijst voor de volgende pass):** (1) Dominion-post kleurt warmer dan het gelockte zalm-oxide — TexMix/kleur bijstellen; (2) straat-dressing op de lege voorgrond (markeringen/decals als no-collision-dressing); (3) glow-raamstroken schaars zichtbaar vanaf de grond; (4) de **lit-toon-migratie** (echt N·L + VSM + software-Lumen-GI; dan wordt SSAO zinvol); (5) particles (vonken/as/embers).
