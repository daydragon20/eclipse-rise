...
| 21 | **R3-criterium 1 (antwoord binnen 1 s) kan vandaag niet falen.** De slechtst gemeten order-round-trip is **0,000 s**: beide tijdstempels staan in dezelfde functie-aanroep, dus vraag en antwoord vallen in hetzelfde frame. | **Laat het criterium staan** — als bewaker is het waardevol, want het gaat rood zodra iemand het orderpad asynchroon maakt. Maar reken het niet mee als bewijs dat het antwoord goed *voelt*; dat kun je pas beoordelen als de acht ingesproken zinnen zijn aangesloten (punt 19). |
