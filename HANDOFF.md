...
**Bekende volgende zwakste punten (15.8-lijst):** (1) Pillow-decals: propaganda/waarschuwingsborden genereren + als deco-planes plaatsen (15.5 occupation story); (2) Quaternius-characterpack binnenhalen (FBX) als squad/vijand-placeholder; (3) particles (vonken/as/embers); (4) district-verticaliteit (03.3); (5) lit-toon herbeoordelen bij interieur/dag-scène.
