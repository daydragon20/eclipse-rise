...
window.PROGRESS_DATA = {
  ...
  taken: [
    ...
    { taak: "Audio-import + koppeling (16.12)", status: "bezig", pct: 70, detail: "IMPORT GELAND (937f35f): alle 8 gebankte assets staan als engine-assets in /Game/Audio — waves + 5 SoundCues met attenuation, het Kessara-bed looping (never-silent-vloer), de verzets-sting in Music/. Onderweg een UE 5.8-API-fix in het importscript (InitialSoundWaves-array). NU: element-builder bouwt de runtime-koppeling — bed geplaatst in het district + sting op Event.Mission.Completed (audio als pure bus-consumer). Follow-ups: 16.x-citatiefixes in de scripts, /Game/Audio-structuur vs 16.14." },
