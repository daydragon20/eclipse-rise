...
window.PROGRESS_DATA = {
  ...
  taken: [
    ...
    { taak: "Stap 3: MetaHuman-pijplijn", status: "wachten", pct: 70, detail: "Slots + recepten klaar; Fab-login werkt. EERSTE CONTENT-LANDING GEDETECTEERD (monitor, 15:30): Atira_LODSettings + Locodrome verschenen in Eclipse/Content — owner is in de editor packs aan het binnenhalen. Inventaris + curatie + koppeling aan DT_NamedCharacters volgt zodra de editor sluit. Daarna: MH_<Naam>-gezichten per phase0/metahuman_recipes.md." },
