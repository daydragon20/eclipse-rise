...
window.PROGRESS_DATA = {
  ...
  taken: [
    ...
    { taak: "P2-03: Hollow Point (stap 1-2 klaar, stap 3 volgt)", status: "bezig", pct: 80, detail: "Stap 1-2 GELAND (deabc9f, review GO — 'R6-discipline voorbeeldig'): DT_Facilities-schema, slot-graph A-D, DA_BaseTuning, FEclipseBaseState mét save v3→v4 + byte-getrouwe v3-fixture (spec-startstand = type-default: gratis L1 CC op Slot_A), hash-dekking compleet, 5 headless tests — eindbar 47/47 ✓. STAP 3 (wrapper + Event.Base.* + materialisatie) draagt de review-bevindingen VERPLICHT mee: (1) bemande-facility-round-trip-fixture + hash-assert zodra StaffAssign bestaat; (2) upgrade-completion NewLevel==2-test + yield-retentie/analist-suspensie-test; (3) crew-timing-semantiek expliciet beslissen; (4) ReleasedSoldierIds aan completion-struct; (5) ApplyRush-guard." },
    { taak: "15.8 dressing-ronde: rubble/warehouse + watch-items", status: "gepland", pct: 0, detail: "NA pack-slim (zelfde builder-lock, serieel): A3-slagkei + C1-brokstukken (3-5× geïnstanced ónder A3) als Contested-rubble tegen de perimeterwal, A1-plinth als loading-dock in de warehouse-yard; SciFi10-slots 5/6/7/9/10 (warehouse-binnenwand, machine-bank, BldgA-trim, treadplate-ramps, gantry-grid) en de 3 ongeplaatste ambientCG-albedo's (Metal046B 19.76, Concrete042A 8.94, Metal063 6.42) op hun curatie-bestemmingen — gains al gemeten, niet schatten. In dezelfde ronde de watch-items: teal-fin cam 6, perimeterband cam 4, crosshatch-tiling + horizon-audit, én (pack-slim-review NTH) één cold-DDC-open van de 7 gemigreerde SciFi10-albedo's als fresh-machine-check. EERSTE EDIT: de 3-string-swap in EclipseGrayboxBuilder.cpp:161/720/741 naar de Imported-paden, daarna mogen de stubs weg. Shotronde + art-review per 15.8 vóór commit." },
