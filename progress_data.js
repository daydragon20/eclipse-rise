...
window.PROGRESS_DATA = {
  ...
  ownerActies: [
    { titel: "Kit-textures: 195 MB is 80x meer dan waarop je 'A' baseerde — nog één keuze", prio: "gauw", waarom: "Je koos A op mijn schatting 'een veelvoud van 2,4 MB'. Nu gemeten: de 12 meshes zijn samen 1,8 MB (die staan er al in), maar de negen 4K-albedo's zijn 194,9 MB. Dat is geen detail, en jij let op schijfruimte — dus die commit ik niet zonder dat je het weet. Ze staan al op schijf, dus wat je ook kiest is het één handeling en geen nieuwe migratie. MIJN ADVIES IS C, en dat volgt uit het materiaal zelf: de toon-master gebruikt van een albedo ALLEEN de luminantie — de textuur levert korrel en waarde, geen kleur en geen detail. Voor die rol is 4K enorme overkill.", stappen: [
      "Optie A: alsnog alle 195 MB committen — maximale trouw aan de bron, maar de repo draagt het voorgoed",
      "Optie B: textures machine-lokaal laten — 0 MB, maar op een andere machine valt de kit terug op vlakke kleur",
      "Optie C (advies): naar 1K downschalen voor ze de repo in gaan — ~12 MB, en in een cel-geshade frame vrijwel niet te zien. Wil je zekerheid, dan meet ik het met een shotronde 4K tegen 1K voordat je kiest",
      "Zeg 'textures: A', 'textures: B' of 'textures: C'"
    ] },
