...
window.PROGRESS_DATA = {
  ...
  ownerActies: [
    ...
    { titel: "MetaHuman-gezichten binnenhalen", prio: "gauw", waarom: "SentinelC is al gecureerd + provisioneel aan Kaya gekoppeld; de rest van de slots wacht", afgekeurd: "Bijna aftekenbaar (11:45): Frey is vandaag binnengekomen én — verrassing — Hannah en Mason stonden er al sinds 23-07; de set lijkt compleet, incl. kleding (hoodie/cargopants/boots). Er zijn nog een paar 'missing optional item'-meldingen in de log; de bewijs-probe draait automatisch zodra je de editor sluit — dan teken ik af of meld ik wat er precies mist.", stappen: [
  ...
  taken: [
    ...
    { taak: "Civilians/workers: gestileerd gratis pack zoeken of zelf bouwen", status: "bezig", pct: 70, detail: "OOGST BINNEN (25-07 12:00): 11 CC0-civilian-bodies (6M/5V — Worker/Farmer/Hoodie/Casual/Suit/Punk-varianten, Quaternius Ultimate Modular) gestaged in Saved/QuaterniusStaging mét contactsheets + importscript; 79 botten mét vingers, 24 anim-takes (incl. Interact/Wave), aparte materiaalslots per zone = perfecte palet-MID-fit. Fab-shortlist voor close-ups (optionele kliks): Bubba The Handyman + Casual Characters FREE. MetaHuman-garderobe (hoodie/cargopants/boots, al in huis) gewogen: te zwaar voor figuranten (12.4), wél de principals-laag straks — gated op 15.7-keuze. VOLGENDE: na editor-close headless importeren, builder-wiring met palet-MID's, dan §15.8-shotronde." },
