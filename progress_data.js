...
window.PROGRESS_DATA = {
  ...
  taken: [
    ...
    { taak: "Zelf bouwen (Borderlands-kwaliteit)", status: "klaar", pct: 100, detail: "LIVE: 5 zelfgemaakte straatprops + facade-ensemble (deur/ramen/pilaren/dakrand/schoorsteen) + lantaarns met glow + propagandaborden + kleur-kalibratie + 5 autowrakken — alles groen geverifieerd. Scale-audit 23-07: CableArc bleek 422 uu (eyeball '100× te groot' was stale) — hangt nu op ware maat tussen een lantaarnpaar; poort-portaal (2× GantryBeam + 4× CornerPillar) staat bij Entry_Main." },
    { taak: "Stap 3: MetaHuman-pijplijn", status: "bezig", pct: 55, detail: "Slots GELAND (DT_NamedCharacters, 6 characters met fallback-bodies) + Creator-recepten voor de eigenaar in phase0/metahuman_recipes.md; rest wacht op Fab-tab-login + MH_<Naam>-exports van de eigenaar." },
    ...
    { taak: "Wachtrij eigenaar", status: "wachten", pct: 0, detail: "Fab-tab-login (MetaHuman-downloads) · MH_<Naam>-gezichten (recepten staan klaar) · ElevenLabs-scopes Music/SFX · resterende 'Add to Project'-kliks (Factory Pack e.a.) · 13.2-playtest." }
  ],
