...
| ~~T-5~~ | ~~Mixamo-kliklijst~~ — **✓ BEANTWOORD 31-07: "mixamo".** De owner kiest Mixamo boven het Quaternius-CC0-alternatief voor de animatie-pass. Blijft staan tot die pass start; dan is de kliklijst zijn actie. | — | bij animatie-pass |
| ~~T-6~~ | ~~CI self-hosted runner~~ — **✓ BEANTWOORD 31-07: "ja".** Goedgekeurd. **Let op bij de uitvoering:** Nathan heeft **geen adminrechten**, dus een runner-installatie die daarom vraagt is een nieuwe owner-actie en geen agent-stap — queue hem, bouw er niet omheen. Deblokkeert backlog #12 (14.4-lagen per merge). | — | deze fase |
